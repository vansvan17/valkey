...
#if !defined(VALKEY_TRACE_RDB_H) || defined(LTTNG_UST_TRACEPOINT_HEADER_MULTI_READ)
#define VALKEY_TRACE_RDB_H
...
#endif /* VALKEY_TRACE_RDB_H */

#include <lttng/tracepoint-event.h>

#else /* USE_LTTNG */

#ifndef VALKEY_TRACE_RDB_H
#define VALKEY_TRACE_RDB_H
